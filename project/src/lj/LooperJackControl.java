...
public class LooperJackControl extends Observable {
	...
	public void startRecording() throws LooperJackException {
		if (p == null) {
			...
			try {
				...
				throw new LooperJackException("Unable to use chosen mixer, please select another one.");
	...
	public void setMixer(int mixerNumber) throws LooperJackException {
		...
		try {
			...
			throw new LooperJackException("The line associated with chosen mixer is not available.");
		} catch (IllegalArgumentException e2) {
			throw new LooperJackException("Unable to use chosen mixer, please select another one.");
		} catch (SecurityException e3) {
			throw new LooperJackException(
	...
	public void play(String fileName) {
		...
		LJPlayback playback = new LJPlayback(null, audioFormat, fileName);
		playback.loopOnOff(false);
		Thread playThread = new Thread(playback);
		playThread.start();
